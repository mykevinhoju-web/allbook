...
export function StaffManager({
  ...
  async function handleDelete(member: SalonStaffMember) {
    if (!window.confirm(`Delete “${member.displayName}”? This cannot be undone.`)) {
      return;
    }
    const next = await deleteStaff(staff, member.id);
    setStaff(next);
  }
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
          <label className="relative min-w-0 flex-1">
            ...
            <input
              ...
              placeholder="Search by name, role, specialty, language…"
