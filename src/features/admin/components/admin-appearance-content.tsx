...
export function AdminAppearanceContent() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
      <AdminPageHeader
        title="Appearance"
        description="Colors for the room tablet only. Secondary text controls labels like “This tablet” and “Staff PIN”. Admin, staff, and customer booking stay unchanged."
      />
